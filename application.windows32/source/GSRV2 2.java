...
public void setup(){ 
 ...
 table.addColumn("GSR (Resistance)");
...
cp5.addButton("AddEvent")   //"Participant" is the name of button
    .setPosition(725, 150)  //x and y coordinates of upper left corner of button
    .setSize(150, 70)      //(width, height)
    .setFont(font)
  ;
  
cp5.addButton("SaveAndExit")   //"Participant" is the name of button
    .setPosition(725, 225)  //x and y coordinates of upper left corner of button
    .setSize(150, 70)      //(width, height)
    .setFont(font)
  ;
...
public void draw(){
  ...
  y = valInt;
  
    {
      ...
      //place the new row and value under the "Data" column
      newRow.setInt("GSR (Resistance)", y);
    }
  ...
  text("GSR Value", 200, 200);
  text(valString, 200, 250);
  text("Participant Number:",380, 250);
  text(Pp, 550, 250);
